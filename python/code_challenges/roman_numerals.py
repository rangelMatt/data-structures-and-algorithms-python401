def roman_to_arabic(roman):
  ...
  for i in range(len(roman)-1):
    ...
    print(f'Left char value: {left_value}')
    right_value = convert_character(right_char)
    print(f'Right char value: {right_value}')
    if left_value < right_value:
      left_value =- left_value
    print(f'Compared and deducted left value: {left_value}')
    print(f'This is the double character converted num: {total}')
    total += left_value
  ...
  print(f'This is single character converted num: {total}')
  return total
